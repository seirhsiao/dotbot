...
#
# Contact: xiaojianfang558@linux.com, http://www.seirhsiao.com
#
# License: GNU GPLv3 http://www.gnu.org/licenses/gpl.html
#
# Usage:
#    bash -c "$(curl -LsS https://raw.githubusercontent.com/seirhsiao/dotfiles/master/setup.sh)"
# Manul:
#    cd ~
#    git clone https://github.com/seirhsiao/dotfiles ./
#    cd  dotfiles
#    ./setup.sh
...
#     https://github.com/marcos-hotmart/dotfiles/blob/master/src/setup.sh
#     https://github.com/coderzh/dotfiles/blob/master/setup.sh
# Install fonts:
...
░░██████░░██████   ░░██   ░██  ░██ ███░░██████ ██████
 ...
 ░▓ author ▓ seirhsiao <seirhsiao.com>
 ░▓ code   ▓ http://github.com/seirhsiao/dotfiles
...
"
    ...
    if [[ -f ./links.sh ]];then
       ## first use dotbt to create links if failed then use create_symlinks
       . links.sh
       if [[ $? -ne 0 ]] ;then
